  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-surface px-4 py-8">
      <div className="grid w-full max-w-6xl overflow-hidden rounded-[2rem] theme-card shadow-ambient lg:grid-cols-[1.05fr_0.95fr]">
        <section className="theme-muted p-10">
          <p className="text-sm theme-text-muted">ابدأ تنظيم يومك من أول جلسة</p>
          <h1 className="mt-4 text-4xl font-bold">إنشاء حساب</h1>
          <p className="mt-4 max-w-md text-base leading-8 theme-text-muted">
